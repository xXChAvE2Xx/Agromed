...
<div class="container">
	...
	*/
	...
	$query = "INSERT INTO usuarios (nombre, telefono, correo, contrasena, localidad, estado) VALUES ('$name', '$tel', '$email', '$pass', '$localidad', '$ciudad')";

	if (mysqli_query($conn, $query)) {
		echo "<script>window.location='index?create=true';</script>";		
		} else {
